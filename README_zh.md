...
[![NPM License](https://img.shields.io/npm/l/react-native-animated-header-flat-list)](https://github.com/lukailun/react-native-animated-header-flat-list/blob/master/LICENSE) 
