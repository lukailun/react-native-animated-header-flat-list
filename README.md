...
[![npm](https://img.shields.io/npm/l/react-native-animated-header-flat-list?style=flat-square)](https://github.com/lukailun/react-native-animated-header-flat-list/blob/master/LICENSE) 
